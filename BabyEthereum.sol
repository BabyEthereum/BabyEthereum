...
// File: contracts/BabyEthereumDividendPayingToken.sol
...
// File: contracts/BabyEthereum.sol
...
contract BabyEthereum is ERC20, Ownable {
   ...
   BabyEthereumDividendTracker public dividendTracker;
    ...
    address public marketingWallet = 0x16c8B87c221a30a390647949a3862433053625A5;
    ...
    constructor() public ERC20("Baby Ethereum", "BABYETH") {
...
contract BabyEthereumDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("BabyEthereum_Dividend_Tracker", "BabyEthereum_Dividend_Tracker") {
    	claimWait = 3600;
